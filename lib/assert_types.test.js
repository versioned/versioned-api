...
test('validType - works with string types', () => {
...
test('validType - works with optional string types that also allow null/undefined', () => {
  expect(validType('string?', 'foobar')).toBe(true)
...
test('validType - works with strings containing multiple types separated by pipe', () => {
...
test('validType - works with object types', () => {
...
test('validType - works with array types', () => {
