...
module.exports = async function (c) {
  ...
  c.assertEqual(result.data.sys.versions[0].createdBy, c.data.user.id)
  ...
  c.assertEqual(result.data.sys.versions[1].createdBy, c.data.user.id)
  c.assertEqual(result.data.sys.versions[1].updatedBy, c.data.user.id)
